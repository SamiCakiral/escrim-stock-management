<!-- Fichier : src/main/webapp/WEB-INF/views/mission/mission.jsp -->
                ...
                <body>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
                        ...
                        <div class="container mt-5">
                            <h1 class="mb-4">Liste des missions</h1>
                            ...
                            <button id="btnAddPersonnelShow" class="btn btn-primary mb-3">Ajouter une Mission</button>
